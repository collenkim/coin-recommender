...
- 전체 후보(최대 20개) x 백테스트 이력(최대 약 365일치 1시간봉 ≈ 8,760봉) 처리가 매시 실행 창 내에 완료되는 것을 목표(soft target)
- 실측 (2026-08-11, 8,752봉 기준): 코인당 이치모쿠 0.56초 + 스캔 0.04초 → 거래소 합산 40개 코인 약 24초
