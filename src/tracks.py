...
#
# 중기 손절은 -3% -> -4%로 넓혔다(+0.25% -> +0.29%). 장기는 보유가 7일 -> 48시간으로 짧아지면서
# 손절도 -7% -> -10%로 넓히는 쪽이 나았다(+0.78% -> +0.81%, 구름 위 조건 포함).
...
TRACKS = (
    ...
    TrackSpec(LONG, "장기", 0.10, 0.10, 48, "4h", require_above_cloud=True, min_hit_rate=0.15),
)
